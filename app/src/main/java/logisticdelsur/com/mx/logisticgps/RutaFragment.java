...
public class RutaFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnSalida = view.findViewById(R.id.btn_salida);
        Button btnLlegada = view.findViewById(R.id.btn_llegada);
        btnSalida.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_rutaFragment_to_rutaSalidaChecklistFragment);
            }
        });
        btnLlegada.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_rutaFragment_to_rutaLlegadaChecklistFragment);
            }
        });
    }
}